        ...
        <div style={{ display: "flex", background: "#fff", border: "1.5px solid #e2e8f0", borderRadius: 12, overflow: "hidden", boxShadow: "0 1px 4px rgba(15,23,42,0.06)" }}>
          {["grid", "list"].map((v) => (
            <button
              ...
              aria-label={`${v} view`}
              style={{
                width: 38, height: 34, border: "none", cursor: "pointer",
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {filtered.map((name) => {
              ...
              return (
                ...
                >
                  <span style={{ background: "#f1f5f9", color: "#94a3b8", borderRadius: 999, padding: "3px 10px", fontSize: 10, fontWeight: 700, textTransform: "uppercase", alignSelf: "flex-start" }}>
                    Coming Soon
                  </span>
                  <div>
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, minWidth: 0 }}>
                    <span style={{ width: 28, height: 28, borderRadius: 8, background: "#ecfdf5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, color: "#059669", flexShrink: 0 }}>
                      {i + 1}
                    </span>
                  ...
                  {detailed ? (
                    <a
                      href={`/districts/${detailed.id}`}
                      style={{ fontSize: 12, fontWeight: 700, color: "#059669", background: "#ecfdf5", borderRadius: 999, padding: "5px 14px", whiteSpace: "nowrap", textDecoration: "none", border: "1px solid #d1fae5", flexShrink: 0 }}
                    >
                      View →
                    </a>
                  ) : (
